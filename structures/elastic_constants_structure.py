...
for i in range(6):
    structure.lattice.distortion(lat='bcc',dist='ortho',index=i,relax=False)
...
for i in range(6):
    structure.lattice.distortion(lat='bcc',dist='mono',index=i,relax=False)
...
for i in range(6):
    structure.lattice.distortion(lat='fcc',dist='ortho',index=i,relax=False)
...
for i in range(6):
    structure.lattice.distortion(lat='fcc',dist='mono',index=i,relax=False)
